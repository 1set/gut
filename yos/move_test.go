...
func TestMoveFile(t *testing.T) {
	...
	tests := []struct {
		...
		{"Destination is a symlink to source file", JoinPath(srcRoot, "self_text.txt"), JoinPath(srcRoot, "self_link.txt"), JoinPath(bkRoot, "self_text.txt"), JoinPath(srcRoot, "self_link.txt"), false},
